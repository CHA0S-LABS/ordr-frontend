...
Real-time taker interface for the ordr on-chain orderbook. Connects to a Solana wallet, displays the live order book and price chart, and submits market orders through the backend matching engine.

Part of the ordr ecosystem - see [p-orderbook](https://github.com/ordrdottrade/ordr) for the on-chain program that this UI settles against.
...
- [p-orderbook](https://github.com/ordrdottrade/ordr) - on-chain program
- [ordr-backend](https://github.com/ordrdottrade/ordr-backend) - indexer + matching engine + REST API this UI talks to
- [ordr-market-maker](https://github.com/ordrdottrade/ordr-market-maker) - MM bot that provides liquidity to the book
